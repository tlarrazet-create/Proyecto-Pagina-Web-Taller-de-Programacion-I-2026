...
<body>
  ...
  <div class="container mt-5 mb-5">
    ...
    <div class="row justify-content-center mb-5 text-center">
        <div class="col-md-8">
            <h2 class="fw-bold mb-4">Nuestra Historia: Detalles que Iluminan tu Esencia</h2>
            <p class="lead text-muted mx-auto" style="line-height: 1.8;">
                En Brightness.Store creemos que cada accesorio es más que una simple pieza; es una expresión de tu identidad. 
                Nacimos en el corazón de Corrientes con una misión simple: crear piezas que resalten tu brillo natural.
            </p>
        </div>
    </div>

    <div class="row justify-content-center mb-5 mt-2 g-4">
        <div class="col-md-5">
            <div class="card h-100 border-0 shadow-sm text-center p-4">
                ...
                <div class="card-body p-0">
                    ...
                    <p class="mb-2" style="color: rgb(241, 232, 42); font-weight: 500;">Fundador & Diseño</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-5">
            <div class="card h-100 border-0 shadow-sm text-center p-4">
                <div class="mx-auto mb-4" style="width: 160px; height: 160px; overflow: hidden; border-radius: 50%; border: 3px solid #f9f6c4;">
                    <img src="{{ asset('images/creadores/4x4(2).jpeg') }}" alt="Foto del Creador 2" class="img-fluid" style="width: 100%; height: 100%; object-fit: cover;">
                </div>
                <div class="card-body p-0">
                    <h4 class="fw-bold">Larrazet Tomas</h4>
                    <p class="mb-2" style="color: rgb(241, 232, 42); font-weight: 500;">Co-Fundador/a & Logística</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row mt-5 pt-4 border-top">
        <h3 class="text-center fw-bold mb-4">Artesanía con Propósito</h3>
    ...
    <div class="row mt-5 pt-4 text-center">
        <h3 class="fw-bold mb-5">Nuestros Valores</h3>
